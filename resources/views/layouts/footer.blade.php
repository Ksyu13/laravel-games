...
src="{{ asset('assets/bower_components/HexagonProgress/jquery.hexagonprogress.min.js') }}">
</script>
...
<!-- Smooth Scroll -->
<script type="text/javascript" src="{{ asset('assets/bower_components/smoothscroll-for-websites/SmoothScroll.js') }}">
</script>

<!-- Owl Carousel -->
<script type="text/javascript" src="{{ asset('assets/bower_components/owl.carousel/dist/owl.carousel.min.js') }}">
</script>

<!-- Countdown -->
<script type="text/javascript"
src="{{ asset('assets/bower_components/jquery.countdown/dist/jquery.countdown.min.js') }}">
</script>

<!-- Magnific Popup -->
<script type="text/javascript"
src="{{ asset('assets/bower_components/magnific-popup/dist/jquery.magnific-popup.min.js') }}">
</script>
<!-- Youplay -->
