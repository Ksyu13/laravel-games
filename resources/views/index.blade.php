...
<section class="content-wrap">
        ...
        <div class="info">
            <div>
                <div class="container">
                    ...
                    <a class="btn btn-md btn-white ml-6" href="#!"><i class="fa fa-apple"></i>&nbsp; App Store</a><a
                        class="btn btn-md active" href="#!"><i class="fa fa-google"></i>&nbsp; Google Play</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="youplay-content">
        ...
        <section class="container">
            <p class="lead">Eleifend sem ipsum conubia euismod potenti ante ad sem sed, dictumst hymenaeos
                torquent quis. Class leo. Odio orci velit nulla habitasse conubia tempor eleifend dui suscipit mauris
                eget mollis, molestie est justo. Ligula facilisi sociis dignissim
                egestas lectus.</p>
            <p class="lead">Habitant consequat consectetuer ipsum primis rutrum torquent curabitur tempus
                gravida nulla integer nascetur tempus ultrices, hac taciti vitae. Vehicula velit praesent risus rutrum
                lectus.</p>
            <br>
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="responsive-embed responsive-embed-16x9">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/rMfe306QFr4" frameborder="0"
        ...
        <section class="youplay-banner youplay-banner-parallax mt-60" id="testimonials">
            <div class="image"
                style="background-image: url('{{ asset('assets/images/game-brs-2-1920x1006.jpg') }}');"
                data-speed="-0.2">
            </div>
                            ...
                            <div class="col-md-4">
                                <blockquote>
                                    <p class="clients-words">
                                        Purus purus penatibus tempus est risus elit convallis ultrices adipiscing et
                                        mollis fames vivamus.
                                    </p>
                                    <small class="author-name">Adrian Ray</small>
                                    <img class="img-circle" alt="Adrian Ray"
                                        src="{{ asset('assets/images/avatar-user-2.png') }}" />
                                </blockquote>
                            </div>
                            <div class="col-md-4">
                                <blockquote>
                                    <p class="clients-words">
                                        Lacus Ut varius viverra vestibulum eleifend consectetuer proin accumsan pretium
                                        dis ultrices, hendrerit platea. Suspendisse Nunc. Ligula phasellus iaculis
                                        torquent.
                                    </p>
                                    <small class="author-name">Salvador Moore</small>
                                    <img class="img-circle" alt="Salvador Moore"
                                        src="{{ asset('assets/images/avatar-user-3.png') }}" />
                                </blockquote>
                            </div>
                            <div class="col-md-4">
                                <blockquote>
                                    <p class="clients-words">
                                        Curae, sodales facilisi, lacus fringilla ridiculus cras, sed, class class. Class
                                        per faucibus eget Aliquam quam interdum vehicula Pretium dolor. Nunc nascetur
                                        urna phasellus.
                                    </p>
                                    <small class="author-name">Clayton Fields</small>
                                    <img class="img-circle" alt="Clayton Fields"
                                        src="{{ asset('assets/images/avatar-user-4.png') }}" />
                                </blockquote>
                            </div>
                        </div>
                    </div>
        ...
        <section class="youplay-news container">
            ...
            <div class="news-one">
                <div class="row vertical-gutter">
                    ...
                    <div class="col-md-8">
                        <div class="clearfix">
                            <h3 class="h2 pull-left m-0"><a href="blog-post.html">Meet on Apple Devices - Black Rock
                                    Shooter</a></h3>
                            <span class="date pull-right"><i class="fa fa-calendar"></i> May 14, 2016</span>
                        </div>
                        <div class="tags">
                            <i class="fa fa-tags"></i> <a href="#">Release</a>, <a href="#">Black Rock Shooter</a>,
                            <a href="#">iOs</a>, <a href="#">Apple</a>
                        </div>
                        <div class="description">
                            <p>
                                Arcu curabitur magna lorem Luctus. Curabitur eleifend facilisi vulputate nam. Primis
                                magna fringilla sed nunc felis cubilia suscipit adipiscing euismod eros cursus
                                adipiscing dis vel etiam. Per id malesuada facilisi odio.
                            </p>
                        </div>
            ...
            <div class="news-one">
                <div class="row vertical-gutter">
                    ...
                    <div class="col-md-8">
                        <div class="clearfix">
                            <h3 class="h2 pull-left m-0"><a href="blog-post.html">Closed Beta Started Today - Black Rock
                                    Shooter II</a></h3>
                            <span class="date pull-right"><i class="fa fa-calendar"></i> April 24, 2016</span>
                        </div>
                        <div class="tags">
                            <i class="fa fa-tags"></i> <a href="#">Black Rock Shooter II</a>, <a href="#">Beta</a>,
                            <a href="#">Start Today</a>
                        </div>
                        <div class="description">
                            <p>Curabitur. Magnis sapien metus euismod a sociosqu ac phasellus non. Sociosqu, lorem.
                                Curabitur. Adipiscing penatibus tempus habitant, porttitor cum sed.</p>

                            <p>Condimentum justo semper semper elementum. Nulla rhoncus ac eros aliquet praesent massa
                                sed ante sociis vivamus. Vulputate lobortis turpis hymenaeos. Ac ipsum arcu sollicitudin
                                lorem feugiat ullamcorper. Tempus donec iaculis.</p>
                        </div>
                        <a href="blog-post.html" class="btn read-more pull-left">Read More</a>
                    </div>
                </div>
        ...
        <section class="youplay-banner youplay-banner-parallax mt-60" id="exclusive">
            <div class="image" style="background-image: url('assets/images/game-brs-8-1920x1080.jpg');"
                data-speed="-0.2">
            </div>
        ...
        <section class="container">
            <p class="lead">
                Mauris imperdiet. Hymenaeos tempor ultricies ullamcorper neque risus volutpat Eros molestie platea,
                sociosqu convallis, fringilla quam amet. Aliquam est, sapien pellentesque nec quam massa eget per purus
                inceptos ornare Eget.
            </p>
            <br>
            <a class="btn btn-md btn-white ml-6" href="#!"><i class="fa fa-apple"></i>&nbsp; App Store</a><a
                class="btn btn-md active" href="#!"><i class="fa fa-google"></i>&nbsp; Google Play</a>
