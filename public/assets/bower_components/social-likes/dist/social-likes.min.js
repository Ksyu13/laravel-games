    ...
    var k = "social-likes",
        ...
        o = {
            ...
            mailru: {
                ...
                popupUrl:
                    "https://connect.mail.ru/share?share_url={url}&title={title}",
                popupWidth: 492,
                popupHeight: 500,
            },
            vkontakte: {
            ...
            plusone: {
                counterUrl:
                    n + "//share.yandex.ru/gpp.xml?url={url}&callback=?",
                convertNumber: function (a) {
    ...
    (a.fn.socialLikes = function (b) {
        return this.each(function () {
            ...
            f
                ...
                : ((f = new c(
                      d,
                      a.extend({}, a.fn.socialLikes.defaults, b, e(d))
                  )),
                  d.data(k, f));
        });
    }),
            ...
            makeSingleButton: function () {
                if (this.single) {
                    ...
                    b.addClass(k + "_vertical"),
                        ...
                        b.wrapInner(
                            a("<div>", { class: k + "__single-container" })
                        );
                    var c = b.parent(),
        ...
        (d.prototype = {
            ...
            addAdditionalParamsToUrl: function (b) {
                var c = a.param(
                    a.extend(this.widget.data(), this.options.data)
                );
            ...
            openPopup: function (b, c) {
                ...
                screen.height > c.height &&
                    (e = Math.round(screen.height / 3 - c.height / 2));
                var f = window.open(
                    b,
                    "sl_" + this.service,
                    "left=" +
                ...
                if (f) {
                    f.focus(),
                        this.widget.trigger("popup_opened." + k, [
                            this.service,
                            f,
                        ]);
                    var g = setInterval(
